...
$('#login-button').click(function(){
    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        "Login successful!";
        $('#login-divider').toggle(1000);
        $('#calendar-requests-divider').toggle(1000);
        $('#calendar-divider').toggle(1000);
...
$('#get-all-events-button').click(function(){
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            document.getElementById("returned-events-divider").innerHTML =
            this.responseText;
        }
        else if (this.readyState == 4 && this.status == 404) {
            document.getElementById("returned-events-divider").innerHTML =
...
$('#get-event-button').click(function(){
    ...
    xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("returned-event-divider").innerHTML =
      this.responseText;
    }
    else if (this.readyState == 4 && this.status == 404) {
        document.getElementById("returned-event-divider").innerHTML =
